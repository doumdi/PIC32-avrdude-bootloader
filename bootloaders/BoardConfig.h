...
//************************************************************************
    ...
    #define FLASH_BYTES                 (0x20000-0x1000)		    // Leave room one flash block (for bootloader!)
    #define FLASH_PAGE_SIZE             1024						// In bytes
#elif defined(_BOARD_PIC32DEV_USB_)
#if defined(PUT_CONFIG_BITS_HERE)
    ...
    //*    Debug settings
    #pragma config ICESEL       = ICS_PGx1                          // ICE pin selection
    #pragma config DEBUG        = ON                                // Debug enabled
    ...
    #define CAPABILITIES    (blCapDownloadLED | blCapUSBInterface | blCapAutoResetListening | blCapVirtualProgramButton | CAPCOMMON)
    ...
    #define DisableBootLED()            (TRISDbits.TRISD4 = 1)
    #define BootLED_Toggle()            (LATDbits.LATD4 = ~LATDbits.LATD4)
    #define BootLED_On()                (LATDbits.LATD4 = 1)
    #define BootLED_Off()               (LATDbits.LATD4 = 0)

    // Download LED
    #define EnableDownLoadLED()         (TRISDbits.TRISD5 = 0)
    #define DisableDownLoadLED()        (TRISDbits.TRISD5 = 1)
    #define DownloadLED_Toggle()        (LATDbits.LATD5 = ~LATDbits.LATD5)
    #define DownloadLED_On()            (LATDbits.LATD5 = 1)
    #define DownloadLED_Off()           (LATDbits.LATD5 = 0)

    // Other capabilities
    //#define fLoadFromAVRDudeViaProgramButton        (PORTEbits.RE7 == 0)
    #define fLoadFromAVRDudeViaVirtualProgramButton (LATBbits.LATB6 == 1)
    #define ClearVirtualProgramButton()             (LATBbits.LATB6 = 0)
